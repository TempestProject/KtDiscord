...
@Serializable class Message(
    ...
    @SerialName("mention_channels") val mentionChannels: List<ChannelMention>? = null,
    ...
    @SerialName("sticker_items") val stickerItems: List<StickerItem>? = null,
    @Deprecated(message = "Deprecated") val stickers: List<Sticker>? = null,
