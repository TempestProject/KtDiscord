 ...
 */
class InteractionCallbackDataMessage(val tts: Boolean?, val content: String?, val embeds: Array<Embed>?, val allowed_mentions: String?, val flags: Short?, val components: Array<String>?, val attachments: Array<String>? = TODO()): InteractionCallbackData
 ...
 */
class InteractionCallbackDataModal(val custom_id: String, val title: String, val components: Array<String>): InteractionCallbackData
